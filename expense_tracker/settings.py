...
SECRET_KEY = 'django-insecure-p5j6l)h-y@xxypixp4b=vn=yn*@_gl9_35c!)n@2_jif64aau$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'expense_tracker',  # Make sure DB exists
        'USER': 'root',             # Your MySQL username
        'PASSWORD': 'Deepu143@.',# Your MySQL password
        'HOST': 'localhost',
        'PORT': '3306',
    }
}
